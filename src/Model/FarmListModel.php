...
class FarmListModel
{
    ...
    private function refreshSingleFarmList($listId, $uid, $fromKid, $personality, $race)
    {
        ...
        // Step 2: Check raid history (last 24 hours) - using movement table
        $targetList = implode(',', $targetKids);
        $yesterday = time() - 86400;
        
        // Note: Using 'movement' table since movement_log might not exist
        $history = $db->query("SELECT `to` as to_kid, 
        ...
        // Step 3: Remove deleted/conquered villages
        ...
        // Step 4: Add new targets if below 10
