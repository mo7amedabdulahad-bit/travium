...
<div class="credits">
    ...
    <p>Developed by: <a href="mailto:admin@travium.net">Amirhossein</a>.</p>
    ...
    <p>
        If you want to get in touch with me send me, an email to <a href="mailto:admin@travium.net">admin@travium.net</a>.
        <br />
