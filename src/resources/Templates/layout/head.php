...
<head>
    ...
    <!-- Mobile Responsive Design - Hide TopBar + Analyzer -->
    <link href="<?=get_gpack_cdn_base_url();?>responsive/mobile.css?v=phase1-header-hide" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="<?=get_gpack_cdn_base_url();?>responsive/mobile-touch.js?v=hide-topbar"></script>
