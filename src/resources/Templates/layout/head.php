...
<head>
    ...
    <!-- Mobile Responsive Design - Fixed Layout (Nav Bottom, Resources Top) -->
    <link href="<?=get_gpack_cdn_base_url();?>responsive/mobile.css?v=fixed-layout" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="<?=get_gpack_cdn_base_url();?>responsive/mobile-touch.js?v=fixed-layout"></script>
