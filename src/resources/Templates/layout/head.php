...
<head>
    ...
    <link href="<?=get_gpack_cdn_base_url();?>responsive/mobile.css?v=emergency-fix" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="<?=get_gpack_cdn_base_url();?>responsive/mobile-touch.js?v=complete-v1"></script>
    <script type="text/javascript" src="<?=get_gpack_cdn_base_url();?>responsive/mobile-swipe.js?v=complete-v1"></script>
