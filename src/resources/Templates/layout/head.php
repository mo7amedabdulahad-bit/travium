...
<head>
    ...
    <!-- Mobile Responsive Design - Fixed Structure -->
    <link href="<?=get_gpack_cdn_base_url();?>responsive/mobile.css?v=fixed-structure" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="<?=get_gpack_cdn_base_url();?>responsive/mobile-touch.js?v=fixed-structure"></script>
