...
<head>
    ...
    <!-- Mobile Responsive Design - Hide Sidebars -->
    <link href="<?=get_gpack_cdn_base_url();?>responsive/mobile.css?v=hide-sidebars" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="<?=get_gpack_cdn_base_url();?>responsive/mobile-touch.js?v=hide-sidebars"></script>
