...
<head>
    ...
    <link href="<?=get_gpack_cdn_base_url();?>responsive/mobile.css?v=official-final" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="<?=get_gpack_cdn_base_url();?>responsive/mobile-nav.js?v=official-final"></script>
