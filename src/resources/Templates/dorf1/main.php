...
<div id="village_map" class="f<?=$vars['fieldType']; ?> village1">
    <div id="resourceFieldContainer" class="resourceField3 tribe<?= $vars['race']; ?> ">
