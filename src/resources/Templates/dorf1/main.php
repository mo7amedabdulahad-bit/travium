        ...
        <table id="production" cellpadding="1" cellspacing="1">
            ...
            <?php for ($i = 0; $i < 4; $i++): ?>
                <tr>
                    ...
                    <td class="res">
                        <?= T("Dorf1", "production.resources." . ($i + 1)); ?>:
                    </td>
                    <td class="num">
                        <?= number_format_x($vars['production'][$i], 1e12); ?>
                    </td>
                </tr>
            <?php endfor; ?>
            </tbody>
