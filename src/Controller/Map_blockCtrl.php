...
class Map_blockCtrl extends AnyCtrl
{
    ...
    {
        // PHP 8.4 compatible: Handle both resource (PHP 7.3) and GdImage object (PHP 8.0+)
        if ($this->imgResource === null || 
            (!is_resource($this->imgResource) && !($this->imgResource instanceof \GdImage))) {
    ...
    {
        // PHP 8.4 compatible: Handle both resource (PHP 7.3) and GdImage object (PHP 8.0+)
        if ($this->snowColor === null || 
            (!is_resource($this->snowColor) && !($this->snowColor instanceof \GdImage))) {
    ...
    private function getNormalColorResource($isWinter)
    {
        ...
        if ($this->normalColor === null || 
            (!is_resource($this->normalColor) && !($this->normalColor instanceof \GdImage))) {
    ...
    private function getDarkColorResource()
    {
        ...
        if ($this->darkColor === null || 
            (!is_resource($this->darkColor) && !($this->darkColor instanceof \GdImage))) {
